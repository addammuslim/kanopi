...
<head>
	...
	<title>Kanopi Membrane Balkon Rumah – Desain Minimalis Modern</title>
...
<section class="mx-auto max-w-7xl px-6 py-12 lg:px-10 lg:py-20">
	...
	<div class="relative group overflow-hidden rounded-xl h-[620px] shadow-2xl head-res">
		...
		src="<?php echo $base_url; ?>/assets/images/webp/portofolio7.webp"
		alt="Kanopi membrane balkon rumah dengan rangka baja lengkung"
		/>
		...
		<div class="absolute bottom-0 left-0 p-8 z-20">
			...
			<h1 class="text-white text-4xl md:text-5xl font-black leading-tight uppercase">
				Kanopi Membrane<br>
				<span class="font-medium">Balkon Rumah</span>
			</h1>
...
<section class="px-6 md:px-10 py-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-12">
	...
	<div class="lg:col-span-2">
		...
		<div class="flex items-center gap-2 text-primary mb-4">
			<span class="material-symbols-outlined text-sm">balcony</span>
		...
		<h2 class="text-3xl font-bold mb-6">
			Proyek Kanopi Membrane Balkon Minimalis
		</h2>

		<p class="text-slate-600 dark:text-slate-400 text-lg leading-relaxed mb-8">

			Pemasangan kanopi membrane pada area balkon rumah dengan desain minimalis modern. Kanopi ini dirancang untuk memberikan perlindungan terhadap panas matahari dan hujan sehingga area balkon tetap nyaman digunakan untuk bersantai atau aktivitas luar ruangan.

		</p>

		<p class="text-slate-600 dark:text-slate-400 text-lg leading-relaxed mb-8">

			Struktur rangka menggunakan pipa baja dengan desain lengkung yang dipasang menempel pada dinding bangunan tanpa menggunakan tiang penopang depan. Material membrane PVC berwarna putih dipasang dengan sistem tarikan yang presisi sehingga menghasilkan tampilan yang bersih, elegan, dan modern.
		...
		<ul class="space-y-4 text-slate-600 dark:text-slate-400">
			...
			<li class="flex items-start gap-3">
				...
				Rangka pipa baja lengkung dengan desain modern
			</li>
			...
			<li class="flex items-start gap-3">
				<span class="flex items-center justify-center w-6 h-6 rounded-full bg-primary text-white text-sm">✓</span>
				Sistem pemasangan cantilever tanpa tiang depan
			</li>
			...
			<li class="flex items-start gap-3">
				<span class="flex items-center justify-center w-6 h-6 rounded-full bg-primary text-white text-sm">✓</span>
				Desain minimalis yang menyatu dengan arsitektur rumah modern
			</li>
		...
		<div class="space-y-6">
			...
			<div class="flex items-center gap-4">
				...
				<div>
					...
					<p class="text-sm font-bold">± 4 – 6 m²</p>
				</div>
			</div>
...
<div class="bg-primary p-8 rounded-xl text-white shadow-xl">
	...
	<p class="mb-6 text-sm">
		Kami melayani pembuatan dan pemasangan kanopi membrane untuk balkon, rooftop, carport, dan area outdoor lainnya dengan desain modern.
	</p>
...
<section class="px-6 md:px-10 py-16  max-w-7xl mx-auto">
  <div class="grid grid-cols-2 md:grid-cols-4 gap-4 h-[600px]">
    <div class="col-span-2 row-span-2 rounded-xl overflow-hidden shadow-lg">
      <img class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" data-alt="Wide shot of the canopy showing architectural context" src="<?php echo $base_url; ?>/assets/images/webp/detail_portofolio7.1.webp"/>
    </div>
    <div class="rounded-xl overflow-hidden shadow-lg">
      <img class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" data-alt="Detail shot of the glass roof panel transparency" src="<?php echo $base_url; ?>/assets/images/webp/detail_portofolio7.2.webp"/>
    </div>
    <div class="rounded-xl overflow-hidden shadow-lg">
      <img class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" data-alt="Steel support joint detail of the canopy" src="<?php echo $base_url; ?>/assets/images/webp/detail_portofolio7.3.webp"/>
    </div>
    <div class="col-span-2 rounded-xl overflow-hidden shadow-lg">
      <img class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" data-alt="Evening shot with integrated LED lighting under canopy" src="<?php echo $base_url; ?>/assets/images/webp/detail_portofolio7.4.webp"/>
    </div>
  </div>
