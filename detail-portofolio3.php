...
<title>Kanopi Membrane Carport Rumah – Desain Modern Minimalis</title>
...
src="<?php echo $base_url; ?>/assets/images/webp/portofolio3.webp"
alt="Kanopi membrane carport rumah minimalis dengan rangka baja putih"
/>
...
Kanopi Membrane<br>
<span class="font-medium">Carport Rumah</span>
</h1>
...
Proyek Kanopi Membrane Carport Rumah Modern
</h2>

<p class="text-slate-600 dark:text-slate-400 text-lg leading-relaxed mb-8">

Proyek pemasangan kanopi membrane pada area carport rumah tinggal dengan desain modern minimalis. 
Kanopi ini dirancang untuk memberikan perlindungan maksimal bagi kendaraan dari panas matahari dan hujan, 
sekaligus meningkatkan tampilan estetika pada fasad rumah.

</p>

<p class="text-slate-600 dark:text-slate-400 text-lg leading-relaxed mb-8">

Struktur rangka menggunakan pipa baja dengan desain lengkung yang kokoh dan stabil. 
Material membrane PVC berwarna putih dipasang dengan sistem tarikan tensile sehingga menghasilkan 
permukaan yang tegang, rapi, dan elegan. Desain ini sangat cocok untuk rumah modern karena memberikan 
kesan ringan namun tetap kuat.
...
Rangka utama menggunakan pipa baja tebal dengan konstruksi kuat
</li>

<li class="flex items-start gap-3">
<span class="flex items-center justify-center w-6 h-6 rounded-full bg-primary text-white text-sm">✓</span>
Desain rangka lengkung modern yang memberikan tampilan elegan
</li>
...
<li class="flex items-start gap-3">
<span class="flex items-center justify-center w-6 h-6 rounded-full bg-primary text-white text-sm">✓</span>
Melindungi kendaraan dari panas matahari dan hujan
</li>
...
<p class="text-sm font-bold">± 30 – 40 m² Area Penutup</p>
</div>
</div>
...
<p class="text-sm font-bold">± 5 Hari Pemasangan</p>
</div>
</div>
...
Konsultasikan kebutuhan kanopi untuk rumah, carport, parkiran, atau area komersial. 
Tim kami siap membantu mulai dari desain hingga pemasangan.
</p>
...
<section class="px-6 md:px-10 py-16  max-w-7xl mx-auto">
  <div class="grid grid-cols-2 md:grid-cols-4 gap-4 h-[600px]">
    <div class="col-span-2 row-span-2 rounded-xl overflow-hidden shadow-lg">
      <img class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" data-alt="Wide shot of the canopy showing architectural context" src="<?php echo $base_url; ?>/assets/images/webp/detail_portofolio3.1.webp"/>
    </div>
    <div class="rounded-xl overflow-hidden shadow-lg">
      <img class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" data-alt="Detail shot of the glass roof panel transparency" src="<?php echo $base_url; ?>/assets/images/webp/detail_portofolio3.3.webp"/>
    </div>
    <div class="rounded-xl overflow-hidden shadow-lg">
      <img class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" data-alt="Steel support joint detail of the canopy" src="<?php echo $base_url; ?>/assets/images/webp/detail_portofolio3.4.webp"/>
    </div>
    <div class="col-span-2 rounded-xl overflow-hidden shadow-lg">
      <img class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" data-alt="Evening shot with integrated LED lighting under canopy" src="<?php echo $base_url; ?>/assets/images/webp/detail_portofolio3.2.webp"/>
    </div>
  </div>
