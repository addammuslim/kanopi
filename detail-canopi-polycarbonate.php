...
<head>
    ...
    <title>Kanopi Polycarbonate Premium | Rizki Abadi Canopy</title>
            ...
            theme: {
                extend: {
                    colors: {
                        ...
                        "polycarbonate-blue": "#1e4b8f",
                        "polycarbonate-teal": "#0f766e"
                    },
                    fontFamily: {
...
<body class="bg-white dark:bg-background-dark text-slate-900 dark:text-slate-100 font-body antialiased">
    ...
    <!-- MAIN CONTENT - KANOPI POLYCARBONATE DETAIL PAGE -->
    <main class="flex-1">
        
        <!-- HERO SECTION - Kanopi Polycarbonate -->
        <section class="relative min-h-[100vh] overflow-hidden pt-2 pb-1 bg-gradient-to-br from-slate-900 via-slate-800 to-polycarbonate-blue head-res" id="polycarbonate-hero">
                ...
                <div class="grid lg:grid-cols-2 gap-16 items-center w-full">
                    ...
                    <div class="text-white space-y-8">
                        ...
                        <div class="inline-flex items-center gap-2 glass px-4 py-2 rounded-full border border-white/20">
                            ...
                            <span class="text-xs font-bold uppercase tracking-widest">Premium Quality · Bening & Kokoh</span>
                        </div>
                        
                        <!-- Main Heading -->
                        <h1 class="text-5xl mt-20 md:text-6xl lg:text-7xl font-black heading-font leading-[1.1]">
                            Kanopi <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-300">Polycarbonate</span>
                        </h1>
                        
                        
                        <!-- Subheadline -->
                        <p class="text-sm text-white/80 leading-relaxed max-w-xl -mt-2">
                            Solusi atap modern dengan material polycarbonate berkualitas tinggi yang ringan, tahan pecah, dan meneruskan cahaya alami untuk hunian maupun komersial Anda.
                        </p>
                        ...
                        <div class="grid grid-cols-2 gap-4 max-w-lg">
                            <div class="flex items-start gap-2">
                                ...
                                <div>
                                    <span class="block font-bold text-sm">Tahan Pecah</span>
                                    <span class="text-xs text-white/60">Kekuatan 200x kaca</span>
                                </div>
                            </div>
                            <div class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary">check_circle</span>
                                <div>
                                    <span class="block font-bold text-sm">Cahaya Masuk</span>
                                    <span class="text-xs text-white/60">Terang alami tanpa silau</span>
                                </div>
                            </div>
                            <div class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary">check_circle</span>
                                <div>
                                    <span class="block font-bold text-sm">Anti UV</span>
                                    <span class="text-xs text-white/60">Lapisan pelindung UV</span>
                                </div>
                            </div>
                            <div class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary">check_circle</span>
                                <div>
                                    <span class="block font-bold text-sm">Ringan</span>
                        ...
                        <div class="flex flex-wrap gap-4">
                            <a href="https://wa.me/<?php echo $nohp; ?>?text=Halo%20saya%20tertarik%20dengan%20Kanopi%20Polycarbonate.%20Mohon%20info%20lebih%20lanjut%20dan%20konsultasi%20gratis." 
                    ...
                    <div class="relative lg:block mt-100">
                        ...
                        <div class="relative rounded-3xl overflow-hidden shadow-2xl border border-white/10 hover-scale">
                            <img src="<?php echo $base_url; ?>/assets/images/webp/canopi-polycarbonate-2.webp" alt="Kanopi Polycarbonate Modern" class="w-full h-auto object-cover">
                        ...
                        <div class="absolute -bottom-6 -left-6 glass-card rounded-2xl p-5 shadow-2xl max-w-[300px] animate-float float-harga">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <!-- <p class="text-2xs text-slate-500">Mulai Rp 350K/m²</p> -->
                                </div>
                            </div>
                        </div>
        ...
        <!-- WHAT IS POLYCARBONATE SECTION -->
        <section class="py-24 bg-white dark:bg-background-dark" id="tentang-polycarbonate">
                ...
                <div class="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <div class="inline-block mb-6">
                            <span class="bg-primary/10 text-primary text-2xs font-bold px-4 py-2 rounded-full uppercase tracking-widest">Apa Itu Kanopi Polycarbonate?</span>
                        </div>
                        
                        <h2 class="text-4xl lg:text-5xl font-black heading-font text-slate-900 dark:text-white mb-6 leading-tight">
                            Atap Transparan dengan <span class="text-primary">Kekuatan Super</span>
                        </h2>
                        
                        <p class="text-lg text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
                            Kanopi Polycarbonate adalah sistem atap yang menggunakan material polimer termoplastik berkualitas tinggi. Dikenal dengan kekuatannya yang 200 kali lebih kuat dari kaca, namun ringan dan mudah dibentuk.
                        </p>
                        ...
                        <div class="space-y-6 mb-8">
                            <div class="flex gap-4">
                                ...
                                <div>
                                    <h3 class="font-bold text-xl text-slate-900 dark:text-white mb-2">Kekuatan Tinggi</h3>
                                    <p class="text-slate-600 dark:text-slate-400">Material polycarbonate memiliki ketahanan benturan yang luar biasa, tidak mudah pecah seperti kaca atau keramik.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-4">
                                ...
                                <div>
                                    <h3 class="font-bold text-xl text-slate-900 dark:text-white mb-2">Meneruskan Cahaya</h3>
                                    <p class="text-slate-600 dark:text-slate-400">Tersedia varian bening yang meneruskan cahaya alami, membuat ruangan di bawahnya terang tanpa perlu lampu di siang hari.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-4">
                                ...
                                <div>
                                    <h3 class="font-bold text-xl text-slate-900 dark:text-white mb-2">Lapisan Anti UV</h3>
                                    <p class="text-slate-600 dark:text-slate-400">Dilapisi dengan teknologi anti UV yang melindungi dari sinar ultraviolet sekaligus mencegah material menguning.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-3 gap-6 pt-6 border-t border-slate-200 dark:border-slate-700">
                            ...
                            <div>
                                ...
                                <div class="text-xs text-slate-500 uppercase tracking-wider">Varian Warna</div>
                            </div>
                            <div>
                    ...
                    <div class="relative">
                        ...
                        <div class="relative rounded-3xl overflow-hidden shadow-2xl">
                            <img src="<?php echo $base_url; ?>/assets/images/webp/Kanopi-Polycarbonate1.webp" alt="Struktur Kanopi Polycarbonate" class="w-full h-auto">
                        ...
                        <div class="absolute -top-6 -right-6 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-5 max-w-[200px] hidden lg:block">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xl font-black text-slate-900 dark:text-white">200x</p>
                                    <p class="text-2xs">lebih kuat dari kaca</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="absolute -bottom-6 -left-6 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-5 max-w-[200px] hidden lg:block">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-xs text-slate-500">Transmisi Cahaya</p>
                                    <p class="text-xl font-black text-slate-900 dark:text-white">90%</p>
                                    <p class="text-2xs">varian bening</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="text-center mt-10">
                    <a href="https://wa.me/<?php echo $nohp; ?>?text=Halo%20<?php echo $sapa; ?>,%20saya%20mau%20tanya%20harga%20dan%20konsultasi%20Kanopi%20Polycarbonate,%20Terimakasih." class="inline-flex items-center gap-3 bg-primary text-white px-8 py-4 rounded-full font-bold hover:bg-primary/90 hover:text-white transition-all group">
            ...
            <div class="max-w-7xl mx-auto px-6 lg:px-10">
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-3">Anti Pecah</h3>
                        <p class="text-slate-600 dark:text-slate-400">Material polycarbonate sangat kuat dan tidak mudah pecah terkena benturan atau hujan es.</p>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-3">Cahaya Alami</h3>
                        <p class="text-slate-600 dark:text-slate-400">Ruangan di bawah kanopi tetap terang di siang hari, menghemat listrik.</p>
                    </div>
        ...
        <section class="py-24 bg-slate-50 dark:bg-slate-900/50" id="spesifikasi">
            <div class="max-w-7xl mx-auto px-6 lg:px-10">
                ...
                <div class="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 class="text-4xl lg:text-5xl font-black heading-font text-slate-900 dark:text-white mb-6">Teknologi & Material Premium Polycarbonate</h2>
                    <p class="text-lg text-slate-600 dark:text-slate-400">Kanopi polycarbonate kami menggunakan material berkualitas tinggi dengan spesifikasi teknik yang terukur untuk hasil maksimal.</p>
                </div>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-xl hover-lift">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-4 heading-font">Material Polycarbonate</h3>
                        <ul class="space-y-3 text-slate-600 dark:text-slate-400">
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">Solid</span> - pejal, kuat</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">Twinwall</span> - berongga, ringan</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">Triplewall</span> - 3 lapis, kokoh</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-xl hover-lift">
                        ...
                        <ul class="space-y-3 text-slate-600 dark:text-slate-400">
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">3mm - 5mm</span> - solid sheet</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">6mm - 10mm</span> - twinwall</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">16mm - 20mm</span> - triplewall</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-xl hover-lift">
                        ...
                        <ul class="space-y-3 text-slate-600 dark:text-slate-400">
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">Lebar lembaran</span> 1.05m - 2.1m</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                            ...
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">Jarak reng</span> 50cm - 100cm</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-xl hover-lift">
                        ...
                        <ul class="space-y-3 text-slate-600 dark:text-slate-400">
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">Anti UV</span> 99%</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                            ...
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">Suhu operasional</span> -40°C s/d 120°C</span>
                            </li>
                        </ul>
                    </div>
        ...
        <section>
            <div class="max-w-7xl mx-auto px-6 lg:px-10">
                <img src="<?php echo $base_url; ?>/assets/images/webp/Kanopi-Polycarbonate-Detail.webp" alt="Struktur Kanopi Spandek" class="w-full h-auto">
            </div>
            <div class="text-center mt-10">
                    <a href="https://wa.me/<?php echo $nohp; ?>?text=Halo%20<?php echo $sapa; ?>,%20saya%20mau%20tanya%20harga%20dan%20konsultasi%20Kanopi%20Polycarbonate,%20Terimakasih." class="inline-flex items-center gap-3 bg-primary text-white px-8 py-4 rounded-full font-bold hover:bg-primary/90 hover:text-white transition-all group">
                        <i class="fa-brands fa-whatsapp"></i>
        ...
        <!-- KEUNGGULAN KANOPI POLYCARBONATE -->
        <section class="py-24 bg-white dark:bg-background-dark" id="keunggulan">
            <div class="max-w-7xl mx-auto px-6 lg:px-10">
                ...
                <div class="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 class="text-4xl lg:text-5xl font-black heading-font text-slate-900 dark:text-white mb-6">Mengapa Pilih Kanopi Polycarbonate?</h2>
                    <p class="text-lg text-slate-600 dark:text-slate-400">Dibanding material lain, kanopi polycarbonate menawarkan berbagai keunggulan yang sulit ditandingi.</p>
                </div>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-8 hover:bg-primary/5 transition-all duration-300 group">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-3 heading-font">Kekuatan Tinggi</h3>
                        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">200 kali lebih kuat dari kaca, tagainst hujan deras, angin kencang, dan benturan.</p>
                    </div>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-8 hover:bg-primary/5 transition-all duration-300 group">
                        ...
                        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">Varian bening meneruskan hingga 90% cahaya, menciptakan ruang terang alami tanpa silau.</p>
                    </div>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-8 hover:bg-primary/5 transition-all duration-300 group">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-3 heading-font">Ringan & Mudah Dipasang</h3>
                        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">Bobot ringan memudahkan proses pemasangan dan tidak membebani struktur bangunan.</p>
                    </div>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-8 hover:bg-primary/5 transition-all duration-300 group">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-3 heading-font">Lapisan Anti UV</h3>
                        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">Melindungi dari sinar UV berbahaya dan mencegah material menguning (yellowing).</p>
                    </div>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-8 hover:bg-primary/5 transition-all duration-300 group">
                        ...
                        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">Tersedia dalam berbagai varian: bening, bronze, biru, hijau, dan opal (putih susu).</p>
                    </div>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-8 hover:bg-primary/5 transition-all duration-300 group">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-3 heading-font">Insulasi Panas</h3>
                        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">Varian twinwall dan triplewall memiliki rongga udara yang membantu meredam panas.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-24 bg-slate-50 dark:bg-slate-900/50" id="aplikasi">
            <div class="max-w-7xl mx-auto px-6 lg:px-10">
                ...
                <div class="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <p class="text-lg text-slate-600 dark:text-slate-400">Kanopi polycarbonate dapat diaplikasikan di berbagai jenis bangunan, dari residensial hingga komersial.</p>
                </div>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="group relative overflow-hidden rounded-3xl shadow-xl hover-lift">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/Kanopi-Polycarbonate1.webp" alt="Carport Polycarbonate" class="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-700">
                        ...
                        <div class="absolute bottom-0 left-0 p-6 text-white">
                            ...
                            <p class="text-sm text-white/80">Melindungi kendaraan </p>
                        </div>
                    </div>
                    
                    <!-- Item 2: Teras -->
                    <div class="group relative overflow-hidden rounded-3xl shadow-xl hover-lift">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/Kanopi-Polycarbonate2.webp" alt="Teras Polycarbonate" class="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-slate-900/30 to-transparent"></div>
                        <div class="absolute bottom-0 left-0 p-6 text-white">
                    ...
                    <!-- Item 3: Cafe/Resto -->
                    <div class="group relative overflow-hidden rounded-3xl shadow-xl hover-lift">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/Kanopi-Polycarbonate3.webp" alt="Cafe Polycarbonate" class="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-slate-900/30 to-transparent"></div>
                        <div class="absolute bottom-0 left-0 p-6 text-white">
                    ...
                    <!-- Item 4: Kanopi Sekolah -->
                    <div class="group relative overflow-hidden rounded-3xl shadow-xl hover-lift">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/Kanopi-Polycarbonate4.webp" alt="Kanopi Sekolah" class="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-slate-900/30 to-transparent"></div>
                        <div class="absolute bottom-0 left-0 p-6 text-white">
                            <span class="material-symbols-outlined text-3xl mb-2">school</span>
                            <h3 class="text-xl font-bold heading-font">Sekolah</h3>
                            <p class="text-sm text-white/80">Jalan penghubung antar gedung</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-center mt-12">
                    <p class="text-slate-600 dark:text-slate-400">Dan masih banyak lagi: kolam renang, area parkir, balkon, dll.</p>
                </div>
            </div>
            <div class="text-center mt-10">
                    <a href="https://wa.me/<?php echo $nohp; ?>?text=Halo%20<?php echo $sapa; ?>,%20saya%20mau%20tanya%20harga%20dan%20konsultasi%20Kanopi%20Polycarbonate,%20Terimakasih." class="inline-flex items-center gap-3 bg-primary text-white px-8 py-4 rounded-full font-bold hover:bg-primary/90 hover:text-white transition-all group">
        ...
        <!-- <section class="py-24 bg-white dark:bg-background-dark" id="portfolio">
            <div class="max-w-7xl mx-auto px-6 lg:px-10">
                ...
                <div class="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <p class="text-lg text-slate-600 dark:text-slate-400">Berikut adalah beberapa proyek kanopi polycarbonate yang telah kami kerjakan.</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="col-span-1 md:col-span-2 row-span-2 overflow-hidden rounded-3xl group relative h-96">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/portfolio-1.webp" alt="Proyek Polycarbonate 1" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                    ...
                    <div class="overflow-hidden rounded-3xl group relative h-64">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/portfolio-2.webp" alt="Proyek Polycarbonate 2" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                    ...
                    <div class="overflow-hidden rounded-3xl group relative h-64">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/portfolio-3.webp" alt="Proyek Polycarbonate 3" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
                    ...
                    <div class="overflow-hidden rounded-3xl group relative h-64">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/portfolio-4.webp" alt="Proyek Polycarbonate 4" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
                    ...
                    <div class="overflow-hidden rounded-3xl group relative h-64">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/portfolio-5.webp" alt="Proyek Polycarbonate 5" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
                            <h3 class="text-lg font-bold text-white">Kolam Renang</h3>
                        </div>
                    </div>
                    
                    <div class="col-span-1 md:col-span-2 overflow-hidden rounded-3xl group relative h-64">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/portfolio-6.webp" alt="Proyek Polycarbonate 6" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-8">
                            <div>
                                <h3 class="text-2xl font-bold text-white">Lorong Sekolah</h3>
                                <p class="text-white/80">Terang tanpa lampu di siang hari</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- <section class="py-24 bg-slate-50 dark:bg-slate-900/50" id="harga">
            <div class="max-w-7xl mx-auto px-6 lg:px-10">
                ...
                <div class="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 class="text-4xl lg:text-5xl font-black heading-font text-slate-900 dark:text-white mb-6">Paket Pemasangan Kanopi Polycarbonate</h2>
                ...
                <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-xl hover-lift relative">
                        ...
                        <ul class="space-y-3 mb-8">
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                                                <span class="text-sm">Polycarbonate twinwall 6mm</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                        ...
                        <a href="https://wa.me/6281234567890?text=Halo%20saya%20tertarik%20dengan%20Paket%20Hemat%20Kanopi%20Polycarbonate" 
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-2xl hover-lift scale-105 relative border-2 border-primary">
                        ...
                        <ul class="space-y-3 mb-8">
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span class="text-sm">Polycarbonate solid 5mm / twinwall 10mm</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                            ...
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span class="text-sm">Garansi material 8 tahun</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                        ...
                        <a href="https://wa.me/6281234567890?text=Halo%20saya%20tertarik%20dengan%20Paket%20Premium%20Kanopi%20Polycarbonate" 
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-xl hover-lift relative">
                        ...
                        <ul class="space-y-3 mb-8">
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span class="text-sm">Polycarbonate triplewall 16mm / solid 10mm</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                        ...
                        <a href="https://wa.me/6281234567890?text=Halo%20saya%20tertarik%20dengan%20Paket%20Luxury%20Kanopi%20Polycarbonate" 
                           class="block w-full bg-primary/10 text-primary text-center py-3 rounded-xl font-bold hover:bg-primary hover:text-white transition-all duration-300">
                            Konsultasi Gratis
                        </a>
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden">
                        <button class="w-full flex items-center justify-between p-6 text-left hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                            <span class="font-bold text-lg">Berapa lama proses pemasangan kanopi polycarbonate?</span>
                            <span class="material-symbols-outlined text-primary">add</span>
                        </button>
                        <div class="px-6 pb-6 text-slate-600 dark:text-slate-400">
                            Proses pemasangan kanopi polycarbonate umumnya memakan waktu 2-4 hari tergantung luas dan kerumitan desain. Untuk carport rumah standar (20-30m²) biasanya selesai dalam 2-3 hari.
                        </div>
                    </div>
                    
                    <div class="border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden">
                        <button class="w-full flex items-center justify-between p-6 text-left hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                            <span class="font-bold text-lg">Apakah kanopi polycarbonate tahan terhadap cuaca ekstrem?</span>
                            <span class="material-symbols-outlined text-primary">add</span>
                        </button>
                        <div class="px-6 pb-6 text-slate-600 dark:text-slate-400">
                            Sangat tahan. Material polycarbonate dirancang untuk menahan panas matahari (dengan lapisan anti UV), hujan deras, dan angin kencang. Tidak mudah pecah atau retak.
                        </div>
                    </div>
                    ...
                    <div class="border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden">
                        ...
                        <div class="px-6 pb-6 text-slate-600 dark:text-slate-400">
                            Ya, kami memberikan garansi material 5-10 tahun tergantung jenis polycarbonate, dan garansi pemasangan 2 tahun. Jika ada kebocoran atau masalah dalam masa garansi, kami perbaiki gratis.
                        </div>
                    </div>
                    ...
                    <div class="border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden">
                        <button class="w-full flex items-center justify-between p-6 text-left hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                            <span class="font-bold text-lg">Apa perbedaan polycarbonate solid, twinwall, dan triplewall?</span>
                            <span class="material-symbols-outlined text-primary">add</span>
                        </button>
                        <div class="px-6 pb-6 text-slate-600 dark:text-slate-400">
                            Solid berbentuk pejal mirip kaca, sangat kuat dan bening. Twinwall memiliki rongga di tengah, lebih ringan dan insulasi panas lebih baik. Triplewall memiliki 3 lapis dengan 2 rongga, paling kokoh dan insulasi terbaik.
                        </div>
                    </div>
                    
                    <div class="border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden">
                        <button class="w-full flex items-center justify-between p-6 text-left hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                            <span class="font-bold text-lg">Apakah polycarbonate bisa menguning?</span>
                            <span class="material-symbols-outlined text-primary">add</span>
                        </button>
                        <div class="px-6 pb-6 text-slate-600 dark:text-slate-400">
                            Material polycarbonate berkualitas rendah bisa menguning. Namun kami menggunakan polycarbonate dengan lapisan anti UV co-extruded yang melindungi dari sinar UV dan mencegah yellowing (menguning) dalam jangka panjang.
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="py-24 relative overflow-hidden bg-gradient-to-br from-primary to-primary-dark" id="cta">
            ...
            <div class="relative z-20 max-w-4xl mx-auto px-6 lg:px-10 text-center text-white">
                ...
                <h2 class="text-4xl md:text-5xl lg:text-6xl font-black heading-font mb-6">
                    Siap Memiliki Kanopi <br/>Polycarbonate Berkualitas?
                </h2>
