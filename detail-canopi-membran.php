...
<head>
    ...
    <title>Kanopi Membran Premium | Rizki Abadi Canopy</title>
            ...
            theme: {
                extend: {
                    colors: {
                        ...
                        "membrane-blue": "#1e4b8f",
                        "membrane-teal": "#0f766e"
                    },
                    fontFamily: {
...
<body class="bg-white dark:bg-background-dark text-slate-900 dark:text-slate-100 font-body antialiased">
    ...
    <!-- MAIN CONTENT - KANOPI MEMBRAN DETAIL PAGE -->
    <main class="flex-1">
        
        <!-- HERO SECTION - Kanopi Membran -->
        <section class="relative min-h-[100vh] overflow-hidden pt-2 pb-1 bg-gradient-to-br from-slate-900 via-slate-800 to-membrane-blue head-res" id="membran-hero">
                ...
                <div class="grid lg:grid-cols-2 gap-16 items-center w-full">
                    ...
                    <div class="text-white space-y-8">
                        ...
                        <div class="inline-flex items-center gap-2 glass px-4 py-2 rounded-full border border-white/20">
                            ...
                            <span class="text-xs font-bold uppercase tracking-widest">Premium Quality · Harga Terjangkau</span>
                        </div>
                        
                        <!-- Main Heading -->
                        <h1 class="text-5xl mt-20 md:text-6xl lg:text-7xl font-black heading-font leading-[1.1]">
                            Kanopi <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-300">Membran</span>
                        </h1>
                        
                        
                        <!-- Subheadline -->
                        <p class="text-sm text-white/80 leading-relaxed max-w-xl -mt-2">
                            Solusi atap modern dengan material membran premium yang fleksibel, tahan cuaca ekstrem, dan memberikan tampilan arsitektur yang elegan untuk hunian maupun komersial Anda.
                        </p>
                        ...
                        <div class="grid grid-cols-2 gap-4 max-w-lg">
                            <div class="flex items-start gap-2">
                                ...
                                <div>
                                    <span class="block font-bold text-sm">Tahan Panas</span>
                                    <span class="text-xs text-white/60">Suhu turun 5-8°C</span>
                                </div>
                            </div>
                            <div class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary">check_circle</span>
                            ...
                            <div class="flex items-start gap-2">
                                ...
                                <div>
                                    ...
                                    <span class="text-xs text-white/60">Bisa lengkung</span>
                                </div>
                            </div>
                            <div class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary">check_circle</span>
                                <div>
                                    ...
                                    <span class="text-xs text-white/60">Tidak membebani</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-wrap gap-4">
                            <a href="https://wa.me/<?php echo $nohp; ?>?text=Halo%20<?php echo $sapa; ?>,%20saya%20tertarik%20dengan%20Kanopi%20Membran.%20Mohon%20info%20lebih%20lanjut%20dan%20konsultasi%20gratis." 
                    ...
                    <div class="relative lg:block mt-100">
                        ...
                        <div class="relative rounded-3xl overflow-hidden shadow-2xl border border-white/10 hover-scale">
                            <img src="<?php echo $base_url; ?>/assets/images/webp/Kanopi-Membran.webp" alt="Kanopi Membran Modern" class="w-full h-auto object-cover">
                        ...
                        <div class="absolute -bottom-6 -left-6 glass-card rounded-2xl p-5 shadow-2xl max-w-[300px] animate-float float-harga">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <!-- <p class="text-2xs text-slate-500">Mulai Rp 450K/m²</p> -->
                                </div>
                            </div>
                        </div>
        ...
        <!-- WHAT IS MEMBRANE SECTION -->
        <section class="py-24 bg-white dark:bg-background-dark" id="tentang-membran">
                ...
                <div class="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <div class="inline-block mb-6">
                            <span class="bg-primary/10 text-primary text-2xs font-bold px-4 py-2 rounded-full uppercase tracking-widest">Apa Itu Kanopi Membran?</span>
                        </div>
                        
                        <h2 class="text-4xl lg:text-5xl font-black heading-font text-slate-900 dark:text-white mb-6 leading-tight">
                            Solusi Atap Modern dengan <span class="text-primary">Material Premium</span>
                        </h2>
                        
                        <p class="text-lg text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
                            Kanopi membran adalah sistem atap fleksibel yang menggunakan kain teknik berkualitas tinggi (PVC, PVDF, atau PTFE) yang diregangkan dengan rangka baja untuk menciptakan struktur yang kuat, tahan lama, dan estetis.
                        </p>
                        ...
                        <div class="space-y-6 mb-8">
                            <div class="flex gap-4">
                                ...
                                <div>
                                    <h3 class="font-bold text-xl text-slate-900 dark:text-white mb-2">Teknologi Tegangan Tinggi</h3>
                                    <p class="text-slate-600 dark:text-slate-400">Material membran ditarik dengan tegangan tinggi sehingga menghasilkan permukaan yang rata, kokoh, dan tidak mudah melorot.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-4">
                                ...
                                <div>
                                    <h3 class="font-bold text-xl text-slate-900 dark:text-white mb-2">Lapisan Anti UV & Anti Bocor</h3>
                                    <p class="text-slate-600 dark:text-slate-400">Dilapisi dengan teknologi anti UV dan waterproofing, sehingga tahan terhadap panas matahari dan tidak tembus air.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-4">
                                ...
                                <div>
                                    <h3 class="font-bold text-xl text-slate-900 dark:text-white mb-2">Desain Fleksibel & Estetis</h3>
                                    <p class="text-slate-600 dark:text-slate-400">Dapat dibentuk sesuai keinginan: lengkung, kerucut, atau bentuk arsitektur lainnya. Tersedia 50+ pilihan warna.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="relative rounded-3xl overflow-hidden shadow-2xl">
                            <img src="<?php echo $base_url; ?>/assets/images/webp/kanopi.webp" alt="Struktur Kanopi Membran" class="w-full h-auto">
                        ...
                        <div class="absolute -top-6 -right-6 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-5 max-w-[200px] hidden lg:block">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xl font-black text-slate-900 dark:text-white">5-8°C</p>
                        ...
                        <div class="absolute -bottom-6 -left-6 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-5 max-w-[200px] hidden lg:block">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xl font-black text-slate-900 dark:text-white">70%</p>
            ...
            <div class="text-center mt-10">
                    <a href="https://wa.me/<?php echo $nohp; ?>?text=Halo%20<?php echo $sapa; ?>,%20saya%20mau%20tanya%20harga%20dan%20konsultasi%20Kanopi%20Membran,%20Terimakasih." class="inline-flex items-center gap-3 bg-primary text-white px-8 py-4 rounded-full font-bold hover:bg-primary/90 hover:text-white transition-all group">
            ...
            <div class="max-w-7xl mx-auto px-6 lg:px-10">
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-3">5-8°C Lebih Sejuk</h3>
                        <p class="text-slate-600 dark:text-slate-400">Material membran memantulkan panas matahari, suhu di bawah kanopi jauh lebih nyaman.</p>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-3">70% Reduksi Suara</h3>
                        <p class="text-slate-600 dark:text-slate-400">Tidak berisik saat hujan, aktivitas di bawah kanopi tetap nyaman dan tenang.</p>
                    </div>
        ...
        <section class="py-24 bg-slate-50 dark:bg-slate-900/50" id="spesifikasi">
            <div class="max-w-7xl mx-auto px-6 lg:px-10">
                ...
                <div class="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 class="text-4xl lg:text-5xl font-black heading-font text-slate-900 dark:text-white mb-6">Teknologi & Material Premium</h2>
                    <p class="text-lg text-slate-600 dark:text-slate-400">Kanopi membran kami menggunakan material berkualitas tinggi dengan spesifikasi teknik yang terukur untuk hasil maksimal.</p>
                </div>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-xl hover-lift">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-4 heading-font">Material Membran</h3>
                        <ul class="space-y-3 text-slate-600 dark:text-slate-400">
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">PVC Coated Polyester</span> - standar</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">PVDF</span> - anti kotor, self-cleaning</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">PTFE (Teflon)</span> - premium, 30+ tahun</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-xl hover-lift">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-4 heading-font">Ketebalan & Gramasi</h3>
                        <ul class="space-y-3 text-slate-600 dark:text-slate-400">
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">650 gr/m²</span> - standar</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">750 gr/m²</span> - medium</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">900 gr/m²</span> - heavy duty</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-xl hover-lift">
                        ...
                        <ul class="space-y-3 text-slate-600 dark:text-slate-400">
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">Lebar kain</span> 1.5m - 2.5m</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">Bentang bebas</span> hingga 15m tanpa tiang</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-xl hover-lift">
                        ...
                        <ul class="space-y-3 text-slate-600 dark:text-slate-400">
                            ...
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">Tahan api</span> standar internasional</span>
                            </li>
                        </ul>
                    </div>
        ...
        <section>
            <div class="max-w-7xl mx-auto px-6 lg:px-10">
                <img src="<?php echo $base_url; ?>/assets/images/webp/KANOPI-MEMBRAIN-GRID.webp" alt="Struktur Kanopi Spandek" class="w-full h-auto">
            </div>
            <div class="text-center mt-10">
                    <a href="https://wa.me/<?php echo $nohp; ?>?text=Halo%20<?php echo $sapa; ?>,%20saya%20mau%20tanya%20harga%20dan%20konsultasi%20Kanopi%20Membran,%20Terimakasih." class="inline-flex items-center gap-3 bg-primary text-white px-8 py-4 rounded-full font-bold hover:bg-primary/90 hover:text-white transition-all group">
                        <i class="fa-brands fa-whatsapp"></i>
        ...
        <section class="py-24 bg-white dark:bg-background-dark" id="keunggulan">
            <div class="max-w-7xl mx-auto px-6 lg:px-10">
                ...
                <div class="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 class="text-4xl lg:text-5xl font-black heading-font text-slate-900 dark:text-white mb-6">Mengapa Pilih Kanopi Membran?</h2>
                    <p class="text-lg text-slate-600 dark:text-slate-400">Dibanding material lain, kanopi membran menawarkan berbagai keunggulan yang sulit ditandingi.</p>
                </div>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-8 hover:bg-primary/5 transition-all duration-300 group">
                        ...
                        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">Material membran memantulkan panas matahari sehingga suhu di bawah kanopi bisa 5-8°C lebih sejuk dibanding atap metal.</p>
                    </div>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-8 hover:bg-primary/5 transition-all duration-300 group">
                        ...
                        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">Tidak berisik saat hujan. Material membran menyerap suara sehingga aktivitas di bawah kanopi tetap nyaman.</p>
                    </div>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-8 hover:bg-primary/5 transition-all duration-300 group">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-3 heading-font">Desain Fleksibel</h3>
                        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">Dapat dibentuk lengkung, kerucut, atau bentuk unik lainnya. Cocok untuk desain arsitektur modern.</p>
                    </div>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-8 hover:bg-primary/5 transition-all duration-300 group">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-3 heading-font">Cahaya Diffused</h3>
                        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">Material membran menyebarkan cahaya matahari sehingga area di bawahnya terang alami tanpa silau.</p>
                    </div>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-8 hover:bg-primary/5 transition-all duration-300 group">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-3 heading-font">Anti Bakteri & Jamur</h3>
                        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">Lapisan khusus mencegah pertumbuhan jamur, lumut, dan bakteri. Aman untuk kesehatan.</p>
                    </div>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-8 hover:bg-primary/5 transition-all duration-300 group">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-3 heading-font">Ramah Lingkungan</h3>
                        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">Material dapat didaur ulang dan proses produksinya rendah emisi karbon.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-24 bg-slate-50 dark:bg-slate-900/50" id="aplikasi">
            <div class="max-w-7xl mx-auto px-6 lg:px-10">
                ...
                <div class="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <p class="text-lg text-slate-600 dark:text-slate-400">Kanopi membran dapat diaplikasikan di berbagai jenis bangunan, dari residensial hingga komersial.</p>
                </div>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="group relative overflow-hidden rounded-3xl shadow-xl hover-lift">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/portofolio3.webp" alt="Carport Membran" class="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-700">
                    ...
                    <!-- Item 2: Teras -->
                    <div class="group relative overflow-hidden rounded-3xl shadow-xl hover-lift">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/Teras-Gazebo.webp" alt="Teras Membran" class="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-slate-900/30 to-transparent"></div>
                        <div class="absolute bottom-0 left-0 p-6 text-white">
                    ...
                    <!-- Item 3: Cafe/Resto -->
                    <div class="group relative overflow-hidden rounded-3xl shadow-xl hover-lift">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/KANOPI-MEMBRAIN-4.webp" alt="Cafe Membran" class="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-slate-900/30 to-transparent"></div>
                        <div class="absolute bottom-0 left-0 p-6 text-white">
                    ...
                    <!-- Item 4: Parkiran -->
                    <div class="group relative overflow-hidden rounded-3xl shadow-xl hover-lift">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/KANOPI-MEMBRAIN-5.webp" alt="Parkiran Membran" class="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-slate-900/30 to-transparent"></div>
                        <div class="absolute bottom-0 left-0 p-6 text-white">
                ...
                <div class="text-center mt-12">
                    <p class="text-slate-600 dark:text-slate-400">Dan masih banyak lagi: gedung olahraga, area industri, sekolah, masjid, dll.</p>
                </div>
            </div>
            <div class="text-center mt-10">
                    <a href="https://wa.me/<?php echo $nohp; ?>?text=Halo%20<?php echo $sapa; ?>,%20saya%20mau%20tanya%20harga%20dan%20konsultasi%20Kanopi%20Membran,%20Terimakasih." class="inline-flex items-center gap-3 bg-primary text-white px-8 py-4 rounded-full font-bold hover:bg-primary/90 hover:text-white transition-all group">
        ...
        <!-- <section class="py-24 bg-white dark:bg-background-dark" id="portfolio">
            <div class="max-w-7xl mx-auto px-6 lg:px-10">
                ...
                <div class="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <p class="text-lg text-slate-600 dark:text-slate-400">Berikut adalah beberapa proyek kanopi membran yang telah kami kerjakan.</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="col-span-1 md:col-span-2 row-span-2 overflow-hidden rounded-3xl group relative h-96">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/portfolio-1.webp" alt="Proyek Membran 1" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                    ...
                    <div class="overflow-hidden rounded-3xl group relative h-64">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/portfolio-2.webp" alt="Proyek Membran 2" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                    ...
                    <div class="overflow-hidden rounded-3xl group relative h-64">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/portfolio-3.webp" alt="Proyek Membran 3" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
                    ...
                    <div class="overflow-hidden rounded-3xl group relative h-64">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/portfolio-4.webp" alt="Proyek Membran 4" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
                    ...
                    <div class="overflow-hidden rounded-3xl group relative h-64">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/portfolio-5.webp" alt="Proyek Membran 5" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
                            <h3 class="text-lg font-bold text-white">Industrial</h3>
                        </div>
                    </div>
                    
                    <div class="col-span-1 md:col-span-2 overflow-hidden rounded-3xl group relative h-64">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/portfolio-6.webp" alt="Proyek Membran 6" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-8">
                            <div>
                                <h3 class="text-2xl font-bold text-white">Sport Complex</h3>
                                <p class="text-white/80">Bentang 25m tanpa tiang</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- <section class="py-24 bg-slate-50 dark:bg-slate-900/50" id="harga">
            <div class="max-w-7xl mx-auto px-6 lg:px-10">
                ...
                <div class="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 class="text-4xl lg:text-5xl font-black heading-font text-slate-900 dark:text-white mb-6">Paket Pemasangan Kanopi Membran</h2>
                ...
                <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-xl hover-lift relative">
                        ...
                        <ul class="space-y-3 mb-8">
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span class="text-sm">Membran PVC 650 gr/m²</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                        ...
                        <a href="https://wa.me/6281234567890?text=Halo%20<?php echo $sapa; ?>,%20saya%20tertarik%20dengan%20Paket%20Hemat%20Kanopi%20Membran" 
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-2xl hover-lift scale-105 relative border-2 border-primary">
                        ...
                        <div class="mb-6">
                            <span class="text-4xl font-black text-primary">Rp 650K</span>
                            <span class="text-slate-500">/m²</span>
                        </div>
                        ...
                        <ul class="space-y-3 mb-8">
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span class="text-sm">Membran PVDF 750 gr/m² (self-cleaning)</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                        ...
                        <a href="https://wa.me/6281234567890?text=Halo%20<?php echo $sapa; ?>,saya%20tertarik%20dengan%20Paket%20Premium%20Kanopi%20Membran" 
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-xl hover-lift relative">
                        ...
                        <ul class="space-y-3 mb-8">
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span class="text-sm">Membran PTFE 900 gr/m² (30+ tahun)</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                        ...
                        <a href="https://wa.me/6281234567890?text=Halo%20<?php echo $sapa; ?>,saya%20tertarik%20dengan%20Paket%20Luxury%20Kanopi%20Membran" 
                           class="block w-full bg-primary/10 text-primary text-center py-3 rounded-xl font-bold hover:bg-primary hover:text-white transition-all duration-300">
                            Konsultasi Gratis
                        </a>
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden">
                        <button class="w-full flex items-center justify-between p-6 text-left hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                            <span class="font-bold text-lg">Berapa lama proses pemasangan kanopi membran?</span>
                            <span class="material-symbols-outlined text-primary">add</span>
                        </button>
                        <div class="px-6 pb-6 text-slate-600 dark:text-slate-400">
                            Proses pemasangan kanopi membran umumnya memakan waktu 3-7 hari tergantung luas dan kerumitan desain. Untuk carport rumah standar (20-30m²) biasanya selesai dalam 3-4 hari.
                        </div>
                    </div>
                    
                    <div class="border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden">
                        <button class="w-full flex items-center justify-between p-6 text-left hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                            <span class="font-bold text-lg">Apakah kanopi membran tahan terhadap cuaca ekstrem?</span>
                            <span class="material-symbols-outlined text-primary">add</span>
                        </button>
                        <div class="px-6 pb-6 text-slate-600 dark:text-slate-400">
                            Sangat tahan. Material membran dirancang untuk menahan panas matahari (UV 98%), hujan deras, dan angin kencang. Dengan perawatan yang tepat, dapat bertahan 10-25 tahun.
                        </div>
                    </div>
                    ...
                    <div class="border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden">
                        ...
                        <div class="px-6 pb-6 text-slate-600 dark:text-slate-400">
                            Ya, kami memberikan garansi material 5-10 tahun tergantung jenis membran, dan garansi pemasangan 2 tahun. Jika ada kebocoran atau masalah dalam masa garansi, kami perbaiki gratis.
                        </div>
                    </div>
                    ...
                    <div class="border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden">
                        <button class="w-full flex items-center justify-between p-6 text-left hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                            <span class="font-bold text-lg">Apa perbedaan membran PVC, PVDF, dan PTFE?</span>
                            <span class="material-symbols-outlined text-primary">add</span>
                        </button>
                        <div class="px-6 pb-6 text-slate-600 dark:text-slate-400">
                            PVC adalah standar dengan masa pakai 10-15 tahun. PVDF memiliki lapisan self-cleaning dan lebih tahan kotor (15-20 tahun). PTFE adalah premium dengan masa pakai 30+ tahun, tahan api, dan tidak perlu perawatan.
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="py-24 relative overflow-hidden bg-gradient-to-br from-primary to-primary-dark" id="cta">
            ...
            <div class="relative z-20 max-w-4xl mx-auto px-6 lg:px-10 text-center text-white">
                ...
                <h2 class="text-4xl md:text-5xl lg:text-6xl font-black heading-font mb-6">
                    Siap Memiliki Kanopi <br/>Membran Berkualitas?
                </h2>
