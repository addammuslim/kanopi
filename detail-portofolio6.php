...
<title>Kanopi Awning Kain Teras Rumah – Pelindung Pintu dan Jendela</title>
...
src="<?php echo $base_url; ?>/assets/images/webp/portofolio6.webp"
alt="Kanopi awning kain hijau untuk pelindung teras rumah"
/>
...
Kanopi Awning<br>
<span class="font-medium">Teras Rumah</span>
</h1>
...
Proyek Kanopi Awning Kain Teras Rumah
</h2>

<p class="text-slate-600 dark:text-slate-400 text-lg leading-relaxed mb-8">

Pemasangan kanopi awning kain pada area teras rumah yang berfungsi untuk melindungi pintu dan jendela dari paparan sinar matahari serta hujan. Kanopi ini memberikan perlindungan tambahan sekaligus mempercantik tampilan fasad rumah dengan desain yang sederhana namun elegan.

</p>

<p class="text-slate-600 dark:text-slate-400 text-lg leading-relaxed mb-8">

Material kain awning berwarna hijau dipasang pada rangka besi yang kuat dengan bentuk melengkung. Bagian bawah kanopi dilengkapi dengan finishing gelombang dekoratif berwarna putih yang memberikan tampilan klasik serta estetis pada area teras.
...
<li class="flex items-start gap-3">
<span class="flex items-center justify-center w-6 h-6 rounded-full bg-primary text-white text-sm">✓</span>
Material kain awning berkualitas tahan panas dan hujan
</li>

<li class="flex items-start gap-3">
<span class="flex items-center justify-center w-6 h-6 rounded-full bg-primary text-white text-sm">✓</span>
Finishing bagian bawah dengan model scallop gelombang
</li>
...
<li class="flex items-start gap-3">
<span class="flex items-center justify-center w-6 h-6 rounded-full bg-primary text-white text-sm">✓</span>
Memberikan perlindungan pada pintu, jendela, dan area teras
</li>
...
<p class="text-sm font-bold">± 5 – 6 Meter</p>
</div>
</div>
...
Kami melayani pembuatan dan pemasangan kanopi awning untuk rumah, toko, cafe, maupun bangunan komersial dengan berbagai pilihan warna dan ukuran.
</p>
...
<section class="px-6 md:px-10 py-16  max-w-7xl mx-auto">
  <div class="grid grid-cols-2 md:grid-cols-4 gap-4 h-[600px]">
    <div class="col-span-2 row-span-2 rounded-xl overflow-hidden shadow-lg">
      <img class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" data-alt="Wide shot of the canopy showing architectural context" src="<?php echo $base_url; ?>/assets/images/webp/detail_portofolio6.1.webp"/>
    </div>
    <div class="rounded-xl overflow-hidden shadow-lg">
      <img class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" data-alt="Detail shot of the glass roof panel transparency" src="<?php echo $base_url; ?>/assets/images/webp/detail_portofolio6.2.webp"/>
    </div>
    <div class="rounded-xl overflow-hidden shadow-lg">
      <img class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" data-alt="Steel support joint detail of the canopy" src="<?php echo $base_url; ?>/assets/images/webp/detail_portofolio6.3.webp"/>
    </div>
    <div class="col-span-2 rounded-xl overflow-hidden shadow-lg">
      <img class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" data-alt="Evening shot with integrated LED lighting under canopy" src="<?php echo $base_url; ?>/assets/images/webp/detail_portofolio6.4.webp"/>
    </div>
  </div>
