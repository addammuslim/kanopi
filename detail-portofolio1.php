...
<html lang="en"><head>
  ...
  <title>Proyek Kanopi Membrane – Rooftop Area</title>
...
<section class="mx-auto max-w-7xl px-6 py-12 lg:px-10 lg:py-20">
  <div class="relative group overflow-hidden rounded-xl h-[620px] shadow-2xl head-res">
    ...
    <img class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" data-alt="Modern glass canopy architecture at a luxury villa" src="<?php echo $base_url; ?>/assets/images/webp/portofolio1.webp"/>
    <div class="absolute bottom-0 left-0 p-8 z-20">
      <span class="px-3 py-1 bg-primary text-white text-xs font-bold uppercase tracking-widest rounded mb-4 inline-block">Featured Project</span>
      <h1 class="text-white text-4xl md:text-5xl font-black leading-tight uppercase">Kanopi Membrane<br/><span class="font-medium">Rooftop Area Ruko</span></h1>
    </div>
  </div>
</section>
<!-- Project Intro & Specs -->
<section class="px-6 md:px-10 py-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-12">
  <div class="lg:col-span-2">
    <div class="flex items-center gap-2 text-primary mb-4">
      ...
      <span class="text-sm font-semibold uppercase tracking-wider">Rooftop Area Ruko</span>
    </div>
    <h2 class="text-3xl font-bold mb-6">Proyek Kanopi Membrane Rooftop Area Ruko</h2>
    <p class="text-slate-600 dark:text-slate-400 text-lg leading-relaxed mb-8">
      Pemasangan kanopi membrane modern pada area rooftop bangunan di Bandung, Jawa Barat. Kanopi dirancang dengan bentuk lengkung minimalis menggunakan rangka baja kokoh yang dipasang langsung pada struktur bangunan.
    </p>
    <p class="text-slate-600 dark:text-slate-400 text-lg leading-relaxed mb-8">
      Material membrane putih berkualitas dipasang dengan sistem tarikan presisi sehingga menghasilkan permukaan yang tegang, rapi, dan terlihat elegan. Selain berfungsi sebagai pelindung dari panas dan hujan, kanopi ini juga memberikan tampilan modern yang meningkatkan estetika area rooftop.
    </p>
    ...
    <div class="space-y-4 text-slate-600 dark:text-slate-400 leading-relaxed">
      <ul class="space-y-4">
        <li class="flex items-start gap-3">
          ...
          <span>Struktur rangka baja melengkung yang kokoh</span>
        </li>
        <li class="flex items-start gap-3">
          <span class="flex items-center justify-center w-6 h-6 rounded-full bg-primary text-white text-sm">✓</span>
          <span>Tarikan membrane rapi dan simetris</span>
        </li>
        <li class="flex items-start gap-3">
          <span class="flex items-center justify-center w-6 h-6 rounded-full bg-primary text-white text-sm">✓</span>
          <span>Finishing rangka bersih dan presisi</span>
        </li>
        <li class="flex items-start gap-3">
          <span class="flex items-center justify-center w-6 h-6 rounded-full bg-primary text-white text-sm">✓</span>
          <span>Desain modern yang menyatu dengan bangunan</span>
        </li>
      </ul>
    </div>
  </div>
    ...
    <div class="space-y-6">
      ...
      <div class="flex items-center gap-4">
        ...
        <div>
          ...
          <p class="text-sm font-bold">± 24 m² Area Penutup</p>
        </div>
      </div>
...
<!-- Call to Action Card -->
<div class="bg-primary p-8 rounded-xl text-white shadow-xl relative overflow-hidden group">
  <div class="absolute -right-8 -bottom-8 opacity-20 transform group-hover:scale-110 transition-transform">
    <span class="material-symbols-outlined !text-[120px]">request_quote</span>
  </div>
  <h4 class="text-xl font-bold mb-3 relative z-10">TERTARIK DENGAN DESIGN KANOPI SEPERTI INI?</h4>
  <p class="text-primary-50/80 mb-6 relative z-10 text-sm">Konsultasi gratis dan dapatkan penawaran harga khusus.</p>
