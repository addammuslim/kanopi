...
<title>Kanopi Membrane Area Parkir – Struktur Modular Panjang</title>
...
src="<?php echo $base_url; ?>/assets/images/webp/portofolio4.webp"
alt="Kanopi membrane panjang area parkir dengan rangka baja lengkung dan membrane putih"
/>
...
Area Parkir / Area Publik
</span>
</div>

<h2 class="text-3xl font-bold mb-6">
Proyek Kanopi Membrane Modular Area Parkir
</h2>

<p class="text-slate-600 dark:text-slate-400 text-lg leading-relaxed mb-8">

Proyek pemasangan kanopi membrane pada area parkir terbuka yang dirancang untuk melindungi kendaraan dari panas matahari dan hujan. Struktur kanopi dibuat dengan sistem rangka baja modular yang memanjang sehingga mampu menutupi area yang luas dengan tampilan yang modern dan rapi.

</p>

<p class="text-slate-600 dark:text-slate-400 text-lg leading-relaxed mb-8">

Material membrane PVC tensile berwarna putih dipasang menggunakan sistem tarikan yang presisi sehingga menghasilkan permukaan yang tegang, kuat, dan stabil. Desain lengkung pada rangka memberikan tampilan arsitektur yang elegan sekaligus memastikan kekuatan struktur dalam jangka panjang.
...
Struktur rangka menggunakan pipa baja tebal dengan sistem modular
</li>

<li class="flex items-start gap-3">
<span class="flex items-center justify-center w-6 h-6 rounded-full bg-primary text-white text-sm">✓</span>
Desain rangka lengkung modern untuk area bentang panjang
</li>
...
<li class="flex items-start gap-3">
<span class="flex items-center justify-center w-6 h-6 rounded-full bg-primary text-white text-sm">✓</span>
Sambungan rangka dengan sistem las presisi dan konstruksi stabil
</li>

<li class="flex items-start gap-3">
<span class="flex items-center justify-center w-6 h-6 rounded-full bg-primary text-white text-sm">✓</span>
Finishing rangka cat putih tahan cuaca dan tahan karat
</li>
...
<p class="text-sm font-bold">± 200 m² Area Penutup</p>
</div>
</div>
...
<p class="text-sm font-bold">± 30 Meter</p>
</div>
</div>
...
<p class="text-sm font-bold">± 10 – 14 Hari</p>
</div>
</div>
...
Konsultasikan kebutuhan kanopi untuk area parkir, taman, area publik, atau area komersial. 
Kami menyediakan layanan desain, produksi, hingga pemasangan kanopi membrane.
</p>
...
<section class="px-6 md:px-10 py-16  max-w-7xl mx-auto">
  <div class="grid grid-cols-2 md:grid-cols-4 gap-4 h-[600px]">
    <div class="col-span-2 row-span-2 rounded-xl overflow-hidden shadow-lg">
      <img class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" data-alt="Wide shot of the canopy showing architectural context" src="<?php echo $base_url; ?>/assets/images/webp/detail_portofolio4.1.webp"/>
    </div>
    <div class="rounded-xl overflow-hidden shadow-lg">
      <img class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" data-alt="Detail shot of the glass roof panel transparency" src="<?php echo $base_url; ?>/assets/images/webp/detail_portofolio4.2.webp"/>
    </div>
    <div class="rounded-xl overflow-hidden shadow-lg">
      <img class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" data-alt="Steel support joint detail of the canopy" src="<?php echo $base_url; ?>/assets/images/webp/detail_portofolio4.3.webp"/>
    </div>
    <div class="col-span-2 rounded-xl overflow-hidden shadow-lg">
      <img class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" data-alt="Evening shot with integrated LED lighting under canopy" src="<?php echo $base_url; ?>/assets/images/webp/detail_portofolio4.4.webp"/>
    </div>
  </div>
