...
<head>
    ...
    <title>Kanopi Spandek Premium | Rizki Abadi Canopy</title>
...
<body class="bg-white dark:bg-background-dark text-slate-900 dark:text-slate-100 font-body antialiased">
    ...
    <!-- MAIN CONTENT - KANOPI SPANDEK DETAIL PAGE -->
    <main class="flex-1">
        
        <!-- HERO SECTION - Kanopi Spandek -->
        <section class="relative min-h-[100vh] overflow-hidden pt-2 pb-1 bg-gradient-to-br from-slate-900 via-slate-800 to-spandek-blue head-res" id="spandek-hero">
                ...
                <div class="grid lg:grid-cols-2 gap-16 items-center w-full">
                    ...
                    <div class="text-white space-y-8">
                        ...
                        <div class="inline-flex items-center gap-2 glass px-4 py-2 rounded-full border border-white/20">
                            ...
                            <span class="text-xs font-bold uppercase tracking-widest">Premium Quality · Kuat & Ekonomis</span>
                        </div>
                        
                        <!-- Main Heading -->
                        <h1 class="text-5xl mt-20 md:text-6xl lg:text-7xl font-black heading-font leading-[1.1]">
                            Kanopi <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-300">Spandek</span>
                        </h1>
                        
                        
                        <!-- Subheadline -->
                        <p class="text-sm text-white/80 leading-relaxed max-w-xl -mt-2">
                            Solusi atap ekonomis dengan material spandek berkualitas tinggi yang kuat, tahan karat, dan mudah pemasangannya untuk hunian maupun komersial Anda.
                        </p>
                        ...
                        <div class="grid grid-cols-2 gap-4 max-w-lg">
                            <div class="flex items-start gap-2">
                                ...
                                <div>
                                    <span class="block font-bold text-sm">Kuat & Kokoh</span>
                                    <span class="text-xs text-white/60">Profil gelombang tinggi</span>
                                </div>
                            </div>
                            <div class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary">check_circle</span>
                                <div>
                                    <span class="block font-bold text-sm">Anti Karat</span>
                                    <span class="text-xs text-white/60">Lapisan Zincalume</span>
                                </div>
                            </div>
                            <div class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary">check_circle</span>
                                <div>
                                    <span class="block font-bold text-sm">Ekonomis</span>
                                    <span class="text-xs text-white/60">Harga terjangkau</span>
                                </div>
                            </div>
                            <div class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary">check_circle</span>
                                <div>
                                    <span class="block font-bold text-sm">Pemasangan Cepat</span>
                                    <span class="text-xs text-white/60">Sistem interlock</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-wrap gap-4">
                            <a href="https://wa.me/<?php echo $nohp; ?>?text=Halo%20saya%20tertarik%20dengan%20Kanopi%20Spandek.%20Mohon%20info%20lebih%20lanjut%20dan%20konsultasi%20gratis." 
                    ...
                    <div class="relative lg:block mt-100">
                        ...
                        <div class="relative rounded-3xl overflow-hidden shadow-2xl border border-white/10 hover-scale">
                            <img src="<?php echo $base_url; ?>/assets/images/webp/Kanopi-Spandek.webp" alt="Kanopi Spandek Modern" class="w-full h-auto object-cover">
                        ...
                        <div class="absolute -bottom-6 -left-6 glass-card rounded-2xl p-5 shadow-2xl max-w-[300px] animate-float float-harga">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <!-- <p class="text-2xs text-slate-500">Mulai Rp 250K/m²</p> -->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="absolute -top-6 -right-6 glass-card rounded-2xl p-4 shadow-2xl max-w-[180px] animate-float animation-delay-1000 float-garansi">
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-2xs text-slate-500">Anti bocor & karat</p>
                                </div>
                            </div>
                        </div>
        ...
        <!-- WHAT IS SPANDEK SECTION -->
        <section class="py-24 bg-white dark:bg-background-dark" id="tentang-spandek">
                ...
                <div class="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <div class="inline-block mb-6">
                            <span class="bg-primary/10 text-primary text-2xs font-bold px-4 py-2 rounded-full uppercase tracking-widest">Apa Itu Kanopi Spandek?</span>
                        </div>
                        
                        <h2 class="text-4xl lg:text-5xl font-black heading-font text-slate-900 dark:text-white mb-6 leading-tight">
                            Atap Ekonomis dengan <span class="text-primary">Kekuatan Maksimal</span>
                        </h2>
                        
                        <p class="text-lg text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
                            Kanopi Spandek adalah sistem atap yang menggunakan material lembaran logam berprofil gelombang tinggi, terbuat dari baja lapis zincalume yang kuat, anti karat, dan ekonomis. Sangat cocok untuk berbagai kebutuhan dengan budget terbatas.
                        </p>
                        ...
                        <div class="space-y-6 mb-8">
                            <div class="flex gap-4">
                                ...
                                <div>
                                    <h3 class="font-bold text-xl text-slate-900 dark:text-white mb-2">Kokoh & Tahan Lama</h3>
                                    <p class="text-slate-600 dark:text-slate-400">Profil gelombang tinggi memberikan kekuatan struktural yang baik, mampu menahan beban hujan dan angin.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-4">
                                ...
                                <div>
                                    <h3 class="font-bold text-xl text-slate-900 dark:text-white mb-2">Lapisan Anti Karat</h3>
                                    <p class="text-slate-600 dark:text-slate-400">Material baja dilapisi zincalume (aluminium + seng) yang melindungi dari korosi dan karat.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-4">
                                ...
                                <div>
                                    <h3 class="font-bold text-xl text-slate-900 dark:text-white mb-2">Ekonomis & Efisien</h3>
                                    <p class="text-slate-600 dark:text-slate-400">Harga terjangkau dengan kualitas terbaik, solusi tepat untuk proyek dengan budget terbatas.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="relative rounded-3xl overflow-hidden shadow-2xl">
                            <img src="<?php echo $base_url; ?>/assets/images/webp/Kanopi-Spandek-3.webp" alt="Struktur Kanopi Spandek" class="w-full h-auto">
                        ...
                        <div class="absolute -top-6 -right-6 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-5 max-w-[200px] hidden lg:block">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-xs text-slate-500">Profil Gelombang</p>
                                    <p class="text-xl font-black text-slate-900 dark:text-white">Tinggi</p>
                                    <p class="text-2xs">75-100mm</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="absolute -bottom-6 -left-6 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-5 max-w-[200px] hidden lg:block">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-xs text-slate-500">Lapisan</p>
                                    <p class="text-xl font-black text-slate-900 dark:text-white">Zincalume</p>
                                    <p class="text-2xs">Anti karat</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="text-center mt-10">
                    <a href="https://wa.me/<?php echo $nohp; ?>?text=Halo%20<?php echo $sapa; ?>,%20saya%20mau%20tanya%20harga%20dan%20konsultasi%20Kanopi%20Spandek,%20Terimakasih." class="inline-flex items-center gap-3 bg-primary text-white px-8 py-4 rounded-full font-bold hover:bg-primary/90 hover:text-white transition-all group">
            ...
            <div class="max-w-7xl mx-auto px-6 lg:px-10">
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-3">Kuat & Kokoh</h3>
                        <p class="text-slate-600 dark:text-slate-400">Profil gelombang tinggi memberikan kekuatan struktural maksimal.</p>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-3">Anti Karat</h3>
                        <p class="text-slate-600 dark:text-slate-400">Lapisan zincalume melindungi dari korosi dan karat.</p>
                    </div>
        ...
        <section class="py-24 bg-slate-50 dark:bg-slate-900/50" id="spesifikasi">
            <div class="max-w-7xl mx-auto px-6 lg:px-10">
                ...
                <div class="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 class="text-4xl lg:text-5xl font-black heading-font text-slate-900 dark:text-white mb-6">Teknologi & Material Premium Spandek</h2>
                    <p class="text-lg text-slate-600 dark:text-slate-400">Kanopi spandek kami menggunakan material berkualitas tinggi dengan spesifikasi teknik yang terukur untuk hasil maksimal.</p>
                </div>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-xl hover-lift">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-4 heading-font">Material Spandek</h3>
                        <ul class="space-y-3 text-slate-600 dark:text-slate-400">
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">Baja Lapis Zincalume</span> - anti karat</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">Profil Gelombang</span> - tinggi 75-100mm</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">Tersedia warna</span> - 15+ pilihan</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-xl hover-lift">
                        ...
                        <ul class="space-y-3 text-slate-600 dark:text-slate-400">
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">0.30mm</span> - ekonomis</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">0.35mm</span> - standar</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">0.40mm - 0.50mm</span> - heavy duty</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-xl hover-lift">
                        ...
                        <ul class="space-y-3 text-slate-600 dark:text-slate-400">
                            ...
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">Besi Hollow</span> - ringan, kuat</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-xl hover-lift">
                        ...
                        <ul class="space-y-3 text-slate-600 dark:text-slate-400">
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">Lebar efektif</span> 1000mm</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">Panjang custom</span> hingga 12 meter</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">Jarak reng</span> 80cm - 120cm</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-xl hover-lift">
                        ...
                        <ul class="space-y-3 text-slate-600 dark:text-slate-400">
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">Anti karat</span> - lapisan zincalume</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">Tahan api</span> - material tidak mudah terbakar</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">Reflektif panas</span> - cat coating</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-xl hover-lift">
                        ...
                        <ul class="space-y-3 text-slate-600 dark:text-slate-400">
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span><span class="font-bold text-slate-900 dark:text-white">Garansi material</span> 5-10 tahun</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
        ...
        <section>
            <div class="max-w-7xl mx-auto px-6 lg:px-10">
                <img src="<?php echo $base_url; ?>/assets/images/webp/Kanopi-Spandek-4.webp" alt="Struktur Kanopi Spandek" class="w-full h-auto">
            </div>
            <div class="text-center mt-10">
                    <a href="https://wa.me/<?php echo $nohp; ?>?text=Halo%20<?php echo $sapa; ?>,%20saya%20mau%20tanya%20harga%20dan%20konsultasi%20Kanopi%20Spandek,%20Terimakasih." class="inline-flex items-center gap-3 bg-primary text-white px-8 py-4 rounded-full font-bold hover:bg-primary/90 hover:text-white transition-all group">
                        <i class="fa-brands fa-whatsapp"></i>
        ...
        <section class="py-24 bg-white dark:bg-background-dark" id="keunggulan">
            <div class="max-w-7xl mx-auto px-6 lg:px-10">
                ...
                <div class="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 class="text-4xl lg:text-5xl font-black heading-font text-slate-900 dark:text-white mb-6">Mengapa Pilih Kanopi Spandek?</h2>
                    <p class="text-lg text-slate-600 dark:text-slate-400">Dibanding material lain, kanopi spandek menawarkan solusi ekonomis dengan kualitas terbaik.</p>
                </div>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-8 hover:bg-primary/5 transition-all duration-300 group">
                        <div class="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                            <span class="material-symbols-outlined text-primary text-3xl">attach_money</span>
                        </div>
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-3 heading-font">Harga Ekonomis</h3>
                        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">Solusi atap dengan budget terbatas tanpa mengorbankan kualitas.</p>
                    </div>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-8 hover:bg-primary/5 transition-all duration-300 group">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-3 heading-font">Kuat & Kokoh</h3>
                        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">Profil gelombang tinggi memberikan kekuatan struktural yang baik.</p>
                    </div>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-8 hover:bg-primary/5 transition-all duration-300 group">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-3 heading-font">Anti Karat</h3>
                        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">Lapisan zincalume melindungi dari korosi, awet hingga puluhan tahun.</p>
                    </div>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-8 hover:bg-primary/5 transition-all duration-300 group">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-3 heading-font">Pemasangan Cepat</h3>
                        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">Sistem interlock memudahkan dan mempercepat proses pemasangan.</p>
                    </div>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-8 hover:bg-primary/5 transition-all duration-300 group">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-3 heading-font">Pilihan Warna</h3>
                        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">Tersedia 15+ pilihan warna yang dapat disesuaikan dengan tema bangunan.</p>
                    </div>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-8 hover:bg-primary/5 transition-all duration-300 group">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-3 heading-font">Reflektif Panas</h3>
                        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">Lapisan cat coating memantulkan panas, menjaga suhu di bawah kanopi.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-24 bg-slate-50 dark:bg-slate-900/50" id="aplikasi">
            <div class="max-w-7xl mx-auto px-6 lg:px-10">
                ...
                <div class="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <p class="text-lg text-slate-600 dark:text-slate-400">Kanopi spandek dapat diaplikasikan di berbagai jenis bangunan, dari residensial hingga komersial.</p>
                </div>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="group relative overflow-hidden rounded-3xl shadow-xl hover-lift">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/Kanopi-Spandek-3.webp" alt="Carport Spandek" class="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-700">
                    ...
                    <!-- Item 2: Teras -->
                    <div class="group relative overflow-hidden rounded-3xl shadow-xl hover-lift">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/Kanopi-Spandek-7.webp" alt="Teras Spandek" class="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-slate-900/30 to-transparent"></div>
                        <div class="absolute bottom-0 left-0 p-6 text-white">
                            <span class="material-symbols-outlined text-3xl mb-2">deck</span>
                            <h3 class="text-xl font-bold heading-font">Teras & Gazebo</h3>
                            <p class="text-sm text-white/80">Area santai yang nyaman</p>
                        </div>
                    </div>
                    
                    <!-- Item 3: Gudang -->
                    <div class="group relative overflow-hidden rounded-3xl shadow-xl hover-lift">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/Kanopi-Spandek-5.webp" alt="Gudang Spandek" class="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-slate-900/30 to-transparent"></div>
                        <div class="absolute bottom-0 left-0 p-6 text-white">
                    ...
                    <!-- Item 4: Parkiran Luas -->
                    <div class="group relative overflow-hidden rounded-3xl shadow-xl hover-lift">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/Kanopi-Spandek-6.webp" alt="Parkiran Spandek" class="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-slate-900/30 to-transparent"></div>
                        <div class="absolute bottom-0 left-0 p-6 text-white">
                            ...
                            <p class="text-sm text-white/80">Solusi ekonomis untuk area parkir</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-center mt-12">
                    <p class="text-slate-600 dark:text-slate-400">Dan masih banyak lagi: bangunan industri, warung, sekolah, dll.</p>
                </div>
            </div>
            <div class="text-center mt-10">
                    <a href="https://wa.me/<?php echo $nohp; ?>?text=Halo%20<?php echo $sapa; ?>,%20saya%20mau%20tanya%20harga%20dan%20konsultasi%20Kanopi%20Spandek,%20Terimakasih." class="inline-flex items-center gap-3 bg-primary text-white px-8 py-4 rounded-full font-bold hover:bg-primary/90 hover:text-white transition-all group">
        ...
        <!-- <section class="py-24 bg-white dark:bg-background-dark" id="portfolio">
            <div class="max-w-7xl mx-auto px-6 lg:px-10">
                ...
                <div class="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <p class="text-lg text-slate-600 dark:text-slate-400">Berikut adalah beberapa proyek kanopi spandek yang telah kami kerjakan.</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="col-span-1 md:col-span-2 row-span-2 overflow-hidden rounded-3xl group relative h-96">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/portfolio-1.webp" alt="Proyek Spandek 1" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-8">
                            <div>
                                <h3 class="text-2xl font-bold text-white">Carport Spandek</h3>
                    ...
                    <div class="overflow-hidden rounded-3xl group relative h-64">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/portfolio-2.webp" alt="Proyek Spandek 2" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
                            <h3 class="text-lg font-bold text-white">Teras Rumah</h3>
                        </div>
                    </div>
                    
                    <div class="overflow-hidden rounded-3xl group relative h-64">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/portfolio-3.webp" alt="Proyek Spandek 3" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
                            <h3 class="text-lg font-bold text-white">Gudang Industri</h3>
                        </div>
                    </div>
                    
                    <div class="overflow-hidden rounded-3xl group relative h-64">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/portfolio-4.webp" alt="Proyek Spandek 4" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
                            <h3 class="text-lg font-bold text-white">Area Parkir</h3>
                        </div>
                    </div>
                    
                    <div class="overflow-hidden rounded-3xl group relative h-64">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/portfolio-5.webp" alt="Proyek Spandek 5" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
                            <h3 class="text-lg font-bold text-white">Warung Makan</h3>
                        </div>
                    </div>
                    
                    <div class="col-span-1 md:col-span-2 overflow-hidden rounded-3xl group relative h-64">
                        <img src="<?php echo $base_url; ?>/assets/images/webp/portfolio-6.webp" alt="Proyek Spandek 6" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-8">
                            <div>
                                <h3 class="text-2xl font-bold text-white">Bangunan Sekolah</h3>
                                <p class="text-white/80">Koridor penghubung</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- <section class="py-24 bg-slate-50 dark:bg-slate-900/50" id="harga">
            <div class="max-w-7xl mx-auto px-6 lg:px-10">
                ...
                <div class="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 class="text-4xl lg:text-5xl font-black heading-font text-slate-900 dark:text-white mb-6">Paket Pemasangan Kanopi Spandek</h2>
                ...
                <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-xl hover-lift relative">
                        ...
                        <div class="mb-6">
                            <span class="text-4xl font-black text-primary">Rp 250K</span>
                        ...
                        <ul class="space-y-3 mb-8">
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span class="text-sm">Spandek tebal 0.30mm</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                            ...
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span class="text-sm">Garansi material 3 tahun</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                        ...
                        <a href="https://wa.me/6281234567890?text=Halo%20saya%20tertarik%20dengan%20Paket%20Hemat%20Kanopi%20Spandek" 
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-2xl hover-lift scale-105 relative border-2 border-primary">
                        ...
                        <div class="mb-6">
                            <span class="text-4xl font-black text-primary">Rp 350K</span>
                            <span class="text-slate-500">/m²</span>
                        </div>
                        ...
                        <ul class="space-y-3 mb-8">
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span class="text-sm">Spandek tebal 0.35mm</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                            ...
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span class="text-sm">Garansi material 7 tahun</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                            ...
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span class="text-sm">Finishing cat coating</span>
                            </li>
                        </ul>
                        
                        <a href="https://wa.me/6281234567890?text=Halo%20saya%20tertarik%20dengan%20Paket%20Premium%20Kanopi%20Spandek" 
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-xl hover-lift relative">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-2 heading-font">Paket Heavy Duty</h3>
                        <p class="text-slate-500 dark:text-slate-400 mb-6">Untuk proyek industri & komersial</p>
                        
                        <div class="mb-6">
                            <span class="text-4xl font-black text-primary">Rp 450K</span>
                            <span class="text-slate-500">/m²</span>
                        </div>
                        ...
                        <ul class="space-y-3 mb-8">
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span class="text-sm">Spandek tebal 0.40mm - 0.50mm</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span class="text-sm">Rangka baja galvanis profil besar</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                            ...
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span class="text-sm">Free konsultasi + survey + desain</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm">check_circle</span>
                                <span class="text-sm">Finishing premium + aksesoris</span>
                            </li>
                        </ul>
                        
                        <a href="https://wa.me/6281234567890?text=Halo%20saya%20tertarik%20dengan%20Paket%20Heavy%20Duty%20Kanopi%20Spandek" 
                           class="block w-full bg-primary/10 text-primary text-center py-3 rounded-xl font-bold hover:bg-primary hover:text-white transition-all duration-300">
                            Konsultasi Gratis
                        </a>
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden">
                        <button class="w-full flex items-center justify-between p-6 text-left hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                            <span class="font-bold text-lg">Berapa lama proses pemasangan kanopi spandek?</span>
                            <span class="material-symbols-outlined text-primary">add</span>
                        </button>
                        <div class="px-6 pb-6 text-slate-600 dark:text-slate-400">
                            Proses pemasangan kanopi spandek umumnya memakan waktu 1-3 hari tergantung luas dan kerumitan desain. Untuk carport rumah standar (20-30m²) biasanya selesai dalam 1-2 hari.
                        </div>
                    </div>
                    
                    <div class="border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden">
                        <button class="w-full flex items-center justify-between p-6 text-left hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                            <span class="font-bold text-lg">Apakah kanopi spandek tahan karat?</span>
                            <span class="material-symbols-outlined text-primary">add</span>
                        </button>
                        <div class="px-6 pb-6 text-slate-600 dark:text-slate-400">
                            Ya, spandek dilapisi zincalume (aluminium 55% + seng 43,5%) yang melindungi dari korosi. Untuk ketahanan maksimal, kami sarankan memilih ketebalan minimal 0.35mm.
                        </div>
                    </div>
                    ...
                    <div class="border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden">
                        ...
                        <div class="px-6 pb-6 text-slate-600 dark:text-slate-400">
                            Ya, kami memberikan garansi material 3-10 tahun tergantung ketebalan, dan garansi pemasangan 2 tahun. Jika ada kebocoran atau masalah dalam masa garansi, kami perbaiki gratis.
                        </div>
                    </div>
                    ...
                    <div class="border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden">
                        <button class="w-full flex items-center justify-between p-6 text-left hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                            <span class="font-bold text-lg">Apa perbedaan spandek dengan atap metal biasa?</span>
                            <span class="material-symbols-outlined text-primary">add</span>
                        </button>
                        <div class="px-6 pb-6 text-slate-600 dark:text-slate-400">
                            Spandek memiliki profil gelombang yang lebih tinggi (75-100mm) dibanding atap metal biasa, sehingga lebih kuat dan kokoh. Juga dilapisi zincalume yang lebih tahan karat dibanding galvalum biasa.
                        </div>
                    </div>
                    
                    <div class="border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden">
                        <button class="w-full flex items-center justify-between p-6 text-left hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                            <span class="font-bold text-lg">Apakah spandek berisik saat hujan?</span>
                            <span class="material-symbols-outlined text-primary">add</span>
                        </button>
                        <div class="px-6 pb-6 text-slate-600 dark:text-slate-400">
                            Material logam memang cenderung lebih berisik saat hujan dibanding material lain. Namun kami dapat menambahkan lapisan peredam atau bubble foil untuk meredam suara.
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="py-24 relative overflow-hidden bg-gradient-to-br from-primary to-primary-dark" id="cta">
            ...
            <div class="relative z-20 max-w-4xl mx-auto px-6 lg:px-10 text-center text-white">
                ...
                <h2 class="text-4xl md:text-5xl lg:text-6xl font-black heading-font mb-6">
                    Siap Memiliki Kanopi <br/>Spandek Berkualitas?
                </h2>
